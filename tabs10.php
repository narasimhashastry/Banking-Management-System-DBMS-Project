...
<head>
  ...
  <style>
  body{
    background-image: url('ebanq-developers-page-1024x682.png');
      ...
      <form class="modal-content animate">
        ...
        <div class="container">
          ...
          <form class="modal-content animate" method="POST" action="blockacc.php">
            ...
            <div class="container">
                <h1 style="text-align: center; font-size: 20px; ">Block/Unblock transaction</h1>
	    ...
	    <div id="id07" class="modal" >
          <form class="modal-content animate" method="POST" action="insertloan.php">
            ...
            <div class="container">
                <h1 style="text-align: center; font-size: 20px; ">Insert Loan Records</h1>
